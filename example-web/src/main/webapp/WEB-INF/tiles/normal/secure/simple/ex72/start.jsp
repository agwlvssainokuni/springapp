...
<h2 class="page-header">単純画面遷移: 一括変更系3-補足入力</h2>
<div class="panel-body">
	<s:hasBindErrors name="ex72Form">
		<div class="col-md-offset-2 col-md-10">
			<div class="alert alert-danger" role="alert">
				<f:errors path="ex72Form" element="div" />
				<f:errors path="ex72Form.dt" element="div" />
				<f:errors path="ex72Form.tm" element="div" />
				<f:errors path="ex72Form.dtm" element="div" />
			</div>
		</div>
	</s:hasBindErrors>
	<f:form servletRelativeAction="/secure/simple/ex72/confirm" method="POST" modelAttribute="ex72Form" cssClass="form-horizontal" role="form">
