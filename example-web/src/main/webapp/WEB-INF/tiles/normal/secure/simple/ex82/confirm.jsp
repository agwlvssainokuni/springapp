...
<h2 class="page-header">単純画面遷移: 一括変更系4-補足確認</h2>
<div class="panel-body">
	<f:form servletRelativeAction="/secure/simple/ex82/execute" method="POST" modelAttribute="ex82Form" cssClass="form-horizontal" role="form">
