...
<h2 class="page-header">単純画面遷移: 単票入力系2-登録入力</h2>
<div class="panel-body">
	...
	<f:form servletRelativeAction="/secure/simple/ex20/confirm" method="POST" modelAttribute="ex20Form" cssClass="form-horizontal" role="form">
