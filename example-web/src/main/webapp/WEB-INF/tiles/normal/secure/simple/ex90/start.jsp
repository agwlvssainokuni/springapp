...
<h2 class="page-header">単純画面遷移: アップロード系1-入力</h2>
<div class="panel-body">
	...
	<f:form servletRelativeAction="/secure/simple/ex90/execute" method="POST" modelAttribute="ex90Form" cssClass="form-horizontal" role="form"
