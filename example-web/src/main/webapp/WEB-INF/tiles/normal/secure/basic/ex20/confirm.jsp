...
<h2 class="page-header">基本画面遷移: 単票入力系2-登録確認</h2>
<div class="panel-body">
	<f:form servletRelativeAction="/secure/basic/ex20/execute" method="POST" modelAttribute="basicEx20Form" cssClass="form-horizontal" role="form">
