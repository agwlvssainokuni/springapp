...
<h2 class="page-header">単純画面遷移: 一括変更系1-一括変更入力</h2>
<div class="panel-body">
	...
	<f:form servletRelativeAction="/secure/simple/ex51/confirm" method="POST" modelAttribute="ex51Form" cssClass="form-horizontal" role="form">
