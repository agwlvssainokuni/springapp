...
<h2 class="page-header">単純画面遷移: 一括変更系4-一括変更入力</h2>
<div class="panel-body">
	<ul class="list-inline text-right">
		<li><a href="${baseUri}/simple/ex81/?redir=/secure/simple/ex80/execute">検索結果一覧へ戻る</a></li>
		<li><a href="${baseUri}/simple/ex81/?redir=/secure/simple/ex80/start">検索条件入力へ戻る(維持)</a></li>
		<li><a href="${baseUri}/simple/ex81/?redir=/secure/simple/ex80/">検索条件入力へ戻る(初期)</a></li>
	</ul>
	...
	<f:form servletRelativeAction="/secure/simple/ex81/confirm" method="POST" modelAttribute="ex81Form" cssClass="form-horizontal" role="form">
		<div class="form-group">
			...
			<div class="col-md-2">
				<s:url var="uri" value="/secure/simple/ex82/start">
					<s:param name="dt">
