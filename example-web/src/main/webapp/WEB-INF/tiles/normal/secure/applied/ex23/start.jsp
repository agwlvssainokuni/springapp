...
<h2 class="page-header">応用画面遷移: 単票入力系2-補助入力</h2>
<div class="panel-body">
	<s:hasBindErrors name="appliedEx21Form">
		<div class="col-md-offset-2 col-md-10">
			<div class="alert alert-danger" role="alert">
				<f:errors path="appliedEx21Form" element="div" />
				<s:nestedPath path="appliedEx21Form.item[${param.rownum}]">
	...
	<f:form servletRelativeAction="/secure/applied/ex23/confirm?id=${param.id}&rownum=${param.rownum}" method="POST"
		modelAttribute="appliedEx21Form" cssClass="form-horizontal" role="form">
