...
<h2 class="page-header">単純画面遷移: 一括変更系4-検索条件結果一覧</h2>
<div class="panel-group">
	<div class="panel panel-default">
		...
		<div id="searchForm" class="panel-body panel-collapse collapse ${hasResultList ? '' : 'in'}">
			...
			<f:form servletRelativeAction="/secure/simple/ex80/execute" method="POST" modelAttribute="ex80Form" cssClass="form-horizontal" role="form">
	...
	<c:if test="${hasResultList}">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<f:form servletRelativeAction="/secure/simple/ex80/execute" method="POST" modelAttribute="ex80Form" id="ex80Form2">
				...
				<div>
					<div class="col-md-3">
						<s:nestedPath path="ex80Form">
							<ex:pageSorter cssClass="ex80Sorter" sortOrder="sortOrder1" sortBy="sortBy1"
								sortByItems="${foundation:getLabeledEnumCodeList('cherry.example.web.simple.ex80.SortBy')}" />
							<ex:pageSorter cssClass="ex80Sorter" sortOrder="sortOrder2" sortBy="sortBy2"
								sortByItems="${foundation:getLabeledEnumCodeList('cherry.example.web.simple.ex80.SortBy')}" />
						</s:nestedPath>
					</div>
					<div class="col-md-1">
