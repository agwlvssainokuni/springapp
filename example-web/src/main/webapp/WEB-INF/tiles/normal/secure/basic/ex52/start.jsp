...
<div class="panel-group">
	<div class="panel panel-default">
		...
		<div id="searchForm" class="panel-body panel-collapse collapse ${hasResultList ? '' : 'in'}">
			...
			<f:form servletRelativeAction="/secure/basic/ex52/execute" method="POST" modelAttribute="basicEx50Form" cssClass="form-horizontal"
				role="form">
	...
	<c:if test="${hasResultList}">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<f:form servletRelativeAction="/secure/basic/ex52/execute" method="POST" modelAttribute="basicEx50Form" id="basicEx50Form2">
				...
				<f:form servletRelativeAction="/secure/basic/ex53/start" method="POST" modelAttribute="basicEx50to51Form">
