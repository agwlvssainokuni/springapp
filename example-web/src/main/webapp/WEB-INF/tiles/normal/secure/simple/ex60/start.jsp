...
<div class="panel-group">
	<div class="panel panel-default">
		...
		<div id="searchForm" class="panel-body panel-collapse collapse ${hasResultList ? '' : 'in'}">
			<s:hasBindErrors name="ex60Form">
				<div class="col-md-offset-2 col-md-10">
					<div class="alert alert-danger" role="alert">
						<f:errors path="ex60Form" element="div" />
						<f:errors path="ex60Form.text10" element="div" />
						<f:errors path="ex60Form.int64From" element="div" />
						<f:errors path="ex60Form.int64To" element="div" />
						<f:errors path="ex60Form.decimal1From" element="div" />
						<f:errors path="ex60Form.decimal1To" element="div" />
						<f:errors path="ex60Form.decimal3From" element="div" />
						<f:errors path="ex60Form.decimal3To" element="div" />
						<f:errors path="ex60Form.dtFrom" element="div" />
						<f:errors path="ex60Form.dtTo" element="div" />
						<f:errors path="ex60Form.tmFrom" element="div" />
						<f:errors path="ex60Form.tmTo" element="div" />
						<f:errors path="ex60Form.dtmFromD" element="div" />
						<f:errors path="ex60Form.dtmFromT" element="div" />
						<f:errors path="ex60Form.dtmToD" element="div" />
						<f:errors path="ex60Form.dtmToT" element="div" />
					</div>
				</div>
			</s:hasBindErrors>
			<f:form servletRelativeAction="/secure/simple/ex60/execute" method="POST" modelAttribute="ex60Form" cssClass="form-horizontal" role="form">
	...
	<c:if test="${hasResultList}">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<f:form servletRelativeAction="/secure/simple/ex60/execute" method="POST" modelAttribute="ex60Form" id="ex60Form2">
				...
				<div>
					<div class="col-md-3">
						<s:nestedPath path="ex60Form">
							<ex:pageSorter cssClass="ex60Sorter" sortOrder="sortOrder1" sortBy="sortBy1"
								sortByItems="${foundation:getLabeledEnumCodeList('cherry.example.web.simple.ex60.SortBy')}" />
							<ex:pageSorter cssClass="ex60Sorter" sortOrder="sortOrder2" sortBy="sortBy2"
								sortByItems="${foundation:getLabeledEnumCodeList('cherry.example.web.simple.ex60.SortBy')}" />
						</s:nestedPath>
					</div>
					<div class="col-md-1">
						<ex:refreshButton selector=".ex60Sorter" form="#ex60Form2" />
					</div>
					<div class="col-md-offset-1 col-md-7 text-right">
						<div>
							<ex:pagerDesc pageSet="${pagedList.pageSet}" />
							<ex:pageSize form="#ex60Form2" psz="psz" />
						</div>
						<ex:pagerLink pageSet="${pagedList.pageSet}" form="#ex60Form2" pno="pno" />
					</div>
				</div>
				<f:form servletRelativeAction="/secure/simple/ex61/" method="POST" modelAttribute="ex60to61Form">
					...
					<div>
						<div class="col-md-2">
							<ex:downloadButton form="#ex60Form2" />
						</div>
					</div>
				</f:form>
			</div>
