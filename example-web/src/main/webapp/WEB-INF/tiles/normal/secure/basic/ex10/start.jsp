...
<h2 class="page-header">基本画面遷移: 単票入力系1-登録入力</h2>
<div class="panel-body">
	<s:hasBindErrors name="basicEx10Form">
	...
	<f:form servletRelativeAction="/secure/basic/ex10/confirm" method="POST" modelAttribute="basicEx10Form" cssClass="form-horizontal" role="form">
