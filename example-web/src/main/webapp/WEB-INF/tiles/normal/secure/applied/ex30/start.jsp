...
<h2 class="page-header">応用画面遷移: 検索一覧系1-検索条件結果一覧</h2>
<div class="panel-group">
	<div class="panel panel-default">
		...
		<div id="searchForm" class="panel-body panel-collapse collapse ${hasResultList ? '' : 'in'}">
			<s:hasBindErrors name="appliedEx30Form">
				<div class="col-md-offset-2 col-md-10">
					<div class="alert alert-danger" role="alert">
						<f:errors path="appliedEx30Form" element="div" />
			...
			<f:form servletRelativeAction="/secure/applied/ex30/execute" method="POST" modelAttribute="appliedEx30Form" cssClass="form-horizontal"
				role="form">
				...
				<div class="form-group">
					<div>
						<f:label path="text10" cssClass="col-md-2 control-label" cssErrorClass="col-md-2 control-label has-error"
							cssErrorClass="col-md-2 control-label has-error">文字列【10】</f:label>
					</div>
					<div class="col-md-10">
				...
				<div class="form-group">
					<div>
						<f:label path="int64From" cssClass="col-md-2 control-label" cssErrorClass="col-md-2 control-label has-error"
							cssErrorClass="col-md-2 control-label has-error">整数【64bit】</f:label>
					</div>
					<div class="col-md-3">
	...
	<c:if test="${hasResultList}">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<f:form servletRelativeAction="/secure/applied/ex30/execute" method="POST" modelAttribute="appliedEx30Form" id="appliedEx30Form2">
				...
				<div class="row">
					...
					<div class="col-md-1">
						<ex:refreshButton selector=".my-sorter" form="#appliedEx30Form2" />
					</div>
					<div class="col-md-offset-1 col-md-7 text-right">
						<div>
							<ex:pagerDesc pageSet="${pagedList.pageSet}" />
							<ex:pageSize form="#appliedEx30Form2" psz="psz" />
						</div>
					...
					<tbody>
						<c:forEach var="count" begin="1" end="${pagedList.list.size()}">
							<s:nestedPath path="pagedList.list[${count-1}]">
								<tr>
									<td><s:bind path="id">
											<a href="${baseUri}/applied/ex31/?id=${status.value}"><span class="glyphicon glyphicon-edit"></span>変更</a>
										</s:bind></td>
