...
<h2 class="page-header">応用画面遷移: 単票入力系2-登録入力</h2>
<div class="panel-body">
	<s:hasBindErrors name="appliedEx20Form">
		<div class="col-md-offset-2 col-md-10">
			<div class="alert alert-danger" role="alert">
				<f:errors path="appliedEx20Form" element="div" />
				<s:nestedPath path="appliedEx20Form">
				...
				<c:if test="${!appliedEx20Form.item.isEmpty()}">
					<c:forEach var="count" begin="1" end="${appliedEx20Form.item.size()}">
						<s:nestedPath path="appliedEx20Form.item[${count-1}]">
							<f:errors path="text10" element="div" />
							<f:errors path="text100" element="div" />
							<f:errors path="int64" element="div" />
							<f:errors path="decimal1" element="div" />
	...
	<f:form servletRelativeAction="/secure/applied/ex20/confirm" method="POST" modelAttribute="appliedEx20Form" cssClass="form-horizontal"
		role="form">
			...
			<tbody>
				<c:forEach var="count" begin="1" end="${appliedEx20Form.item.size()}">
					<s:nestedPath path="item[${count-1}]">
						<tr>
							<td><a href="${baseUri}/applied/ex21/?rownum=${count-1}" class="text-nowrap"><span class="glyphicon glyphicon-edit"></span>変更</a></td>
				...
				<tr>
					<td><a href="${baseUri}/applied/ex21/?rownum=${appliedEx20Form.item == null ? 0 : appliedEx20Form.item.size()}" class="text-nowrap"><span
