...
<div class="tab-content">
	<div id="simple" class="tab-pane" role="tabpanel">
		<ul class="list-group list-unstyled">
			...
			<li><a href="${baseUri}/simple/ex50/" class="list-group-item">一括変更系1: 検索条件入力-検索結果一覧(対象選択)-一括変更入力-一括変更確認-一括変更完了-検索結果一覧または検索条件入力</a></li>
			<li><a href="${baseUri}/simple/ex60/" class="list-group-item">一括変更系2: 検索条件入力-検索結果一覧(対象選択)-一括変更入力-一括変更確認-検索結果一覧(変更完了メッセージ)-検索条件入力</a></li>
		</ul>
	</div>
