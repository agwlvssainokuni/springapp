...
<h2 class="page-header">単純画面遷移: 一括変更系4-一括変更確認</h2>
<div class="panel-body">
	...
	<f:form servletRelativeAction="/secure/simple/ex81/execute" method="POST" modelAttribute="ex81Form" cssClass="form-horizontal" role="form">
