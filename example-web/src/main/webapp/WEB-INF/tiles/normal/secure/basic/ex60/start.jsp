...
<h2 class="page-header">基本画面遷移: 一括変更系2-検索条件結果一覧</h2>
<div class="panel-group">
	<div class="panel panel-default">
		...
		<div id="searchForm" class="panel-body panel-collapse collapse ${hasResultList ? '' : 'in'}">
			<s:hasBindErrors name="basicEx60Form">
				<div class="col-md-offset-2 col-md-10">
					<div class="alert alert-danger" role="alert">
						<f:errors path="basicEx60Form" element="div" />
						<f:errors path="basicEx60Form.text10" element="div" />
						<f:errors path="basicEx60Form.int64From" element="div" />
						<f:errors path="basicEx60Form.int64To" element="div" />
						<f:errors path="basicEx60Form.decimal1From" element="div" />
						<f:errors path="basicEx60Form.decimal1To" element="div" />
						<f:errors path="basicEx60Form.decimal3From" element="div" />
						<f:errors path="basicEx60Form.decimal3To" element="div" />
						<f:errors path="basicEx60Form.dtFrom" element="div" />
						<f:errors path="basicEx60Form.dtTo" element="div" />
						<f:errors path="basicEx60Form.tmFrom" element="div" />
						<f:errors path="basicEx60Form.tmTo" element="div" />
						<f:errors path="basicEx60Form.dtmFromD" element="div" />
						<f:errors path="basicEx60Form.dtmFromT" element="div" />
						<f:errors path="basicEx60Form.dtmToD" element="div" />
						<f:errors path="basicEx60Form.dtmToT" element="div" />
					</div>
				</div>
			</s:hasBindErrors>
			<f:form servletRelativeAction="/secure/basic/ex60/execute" method="POST" modelAttribute="basicEx60Form" cssClass="form-horizontal"
				role="form">
	...
	<c:if test="${hasResultList}">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<f:form servletRelativeAction="/secure/basic/ex60/execute" method="POST" modelAttribute="basicEx60Form" id="basicEx60Form2">
				...
				<div>
					<div class="col-md-3">
						<s:nestedPath path="basicEx60Form">
					...
					<div class="col-md-1">
						<ex:refreshButton selector=".ex60Sorter" form="#basicEx60Form2" />
					</div>
					<div class="col-md-offset-1 col-md-7 text-right">
						<div>
							<ex:pagerDesc pageSet="${pagedList.pageSet}" />
							<ex:pageSize form="#basicEx60Form2" psz="psz" />
						</div>
						<ex:pagerLink pageSet="${pagedList.pageSet}" form="#basicEx60Form2" pno="pno" />
					</div>
				</div>
				<f:form servletRelativeAction="/secure/basic/ex61/" method="POST" modelAttribute="basicEx60to61Form">
					...
					<div>
						<div class="col-md-2">
							<ex:downloadButton form="#basicEx60Form2" />
						</div>
					</div>
				</f:form>
			</div>
