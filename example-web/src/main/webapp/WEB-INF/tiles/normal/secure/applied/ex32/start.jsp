...
<h2 class="page-header">応用画面遷移: 検索一覧系1-単票補助入力</h2>
<div class="panel-body">
	<s:hasBindErrors name="appliedEx32Form">
		<div class="col-md-offset-2 col-md-10">
			<div class="alert alert-danger" role="alert">
				<f:errors path="appliedEx32Form" element="div" />
				<s:nestedPath path="appliedEx32Form.item[${param.rownum}]">
	...
	<f:form servletRelativeAction="/secure/applied/ex32/confirm?id=${param.id}&rownum=${param.rownum}" method="POST"
