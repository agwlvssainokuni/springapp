...
<h2 class="page-header">単純画面遷移: 一括変更系1-一括変更確認</h2>
<div class="panel-body">
	<ul class="list-inline text-right">
		<li><a href="${baseUri}/simple/ex51/?redir=/secure/simple/ex50/execute">検索結果一覧へ戻る</a></li>
		<li><a href="${baseUri}/simple/ex51/?redir=/secure/simple/ex50/start">検索条件入力へ戻る(維持)</a></li>
		<li><a href="${baseUri}/simple/ex51/?redir=/secure/simple/ex50/">検索条件入力へ戻る(初期)</a></li>
	</ul>
	<f:form servletRelativeAction="/secure/simple/ex51/execute" method="POST" modelAttribute="ex51Form" cssClass="form-horizontal" role="form">
