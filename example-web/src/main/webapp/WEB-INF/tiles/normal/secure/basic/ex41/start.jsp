...
<div class="panel-body">
	<ul class="list-inline text-right">
		<li><a href="${baseUri}/basic/ex41/?id=${param.id}&redir=/secure/basic/ex40/execute">検索結果一覧へ戻る</a></li>
		<li><a href="${baseUri}/basic/ex41/?id=${param.id}&redir=/secure/basic/ex40/start">検索条件入力へ戻る(維持)</a></li>
		<li><a href="${baseUri}/basic/ex41/?id=${param.id}&redir=/secure/basic/ex40/">検索条件入力へ戻る(初期)</a></li>
	</ul>
