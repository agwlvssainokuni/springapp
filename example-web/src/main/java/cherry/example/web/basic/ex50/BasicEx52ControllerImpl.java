...
@Controller
public class BasicEx52ControllerImpl implements BasicEx52Controller {
	...
	private UriComponents redirectOnInit(String redir) {
		if (StringUtils.isNotEmpty(redir)) {
			...
			return fromMethodCall(on(BasicEx52Controller.class).start(null, null, null, null, null, null)).build();
		}
	}
