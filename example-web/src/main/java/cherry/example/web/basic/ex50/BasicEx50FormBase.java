...
@EqualsAndHashCode
@ToString
public abstract class BasicEx50FormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "basicEx50Form.text10"), //
		Int64From("int64From", "basicEx50Form.int64From"), //
		Int64To("int64To", "basicEx50Form.int64To"), //
		Decimal1From("decimal1From", "basicEx50Form.decimal1From"), //
		Decimal1To("decimal1To", "basicEx50Form.decimal1To"), //
		Decimal3From("decimal3From", "basicEx50Form.decimal3From"), //
		Decimal3To("decimal3To", "basicEx50Form.decimal3To"), //
		DtFrom("dtFrom", "basicEx50Form.dtFrom"), //
		DtTo("dtTo", "basicEx50Form.dtTo"), //
		TmFrom("tmFrom", "basicEx50Form.tmFrom"), //
		TmTo("tmTo", "basicEx50Form.tmTo"), //
		DtmFromD("dtmFromD", "basicEx50Form.dtmFromD"), //
		DtmFromT("dtmFromT", "basicEx50Form.dtmFromT"), //
		DtmToD("dtmToD", "basicEx50Form.dtmToD"), //
		DtmToT("dtmToT", "basicEx50Form.dtmToT"), //
		Sort1("sort1", "basicEx50Form.sort1"), //
		Sort2("sort2", "basicEx50Form.sort2"), //
		Pno("pno", "basicEx50Form.pno"), //
		Psz("psz", "basicEx50Form.psz"), //
		DUMMY("dummy", "dummy");
