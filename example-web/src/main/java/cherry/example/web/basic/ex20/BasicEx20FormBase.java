...
@EqualsAndHashCode
@ToString
public abstract class BasicEx20FormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "basicEx20Form.text10"), //
		Text100("text100", "basicEx20Form.text100"), //
		Int64("int64", "basicEx20Form.int64"), //
		Decimal1("decimal1", "basicEx20Form.decimal1"), //
		Decimal3("decimal3", "basicEx20Form.decimal3"), //
		Dt("dt", "basicEx20Form.dt"), //
		Tm("tm", "basicEx20Form.tm"), //
		Dtm("dtm", "basicEx20Form.dtm"), //
		LockVersion("lockVersion", "basicEx20Form.lockVersion"), //
		DUMMY("dummy", "dummy");
