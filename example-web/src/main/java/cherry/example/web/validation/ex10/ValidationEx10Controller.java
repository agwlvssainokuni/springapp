...
@RequestMapping(URI_VALIDATION_EX10)
public interface ValidationEx10Controller {
	...
	ModelAndView start(@Validated(G9.class) ValidationEx10Form form, BindingResult binding, Authentication auth,
			Locale locale, SitePreference sitePref, NativeWebRequest request);
