...
@Controller
public class AppliedEx31ControllerImpl implements AppliedEx31Controller {

	@Autowired
	private OneTimeTokenValidator oneTimeTokenValidator;

	@Autowired
	private AppliedEx31Service service;

	private final String viewnameOfStart = ViewNameUtil.fromMethodCall(on(AppliedEx31Controller.class).start(0L, null,
	...
	@Override
	public ModelAndView start(long id, AppliedEx31Form form, BindingResult binding, Authentication auth, Locale locale,
	...
	@Override
	public ModelAndView back(long id, AppliedEx31Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
		return withViewname(viewnameOfStart).build();
	}
