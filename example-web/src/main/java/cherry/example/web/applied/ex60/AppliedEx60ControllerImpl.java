...
import cherry.example.web.applied.ex60.AppliedEx60FormBase.Prop;
...
public class AppliedEx60ControllerImpl implements AppliedEx60Controller {
	...
	private final String viewnameOfStart = ViewNameUtil.fromMethodCall(on(AppliedEx60Controller.class).start(null,
