...
public class AppliedEx11Form {
	...
	public static String getItemPropName(int rownum, AppliedEx10SubFormBase.Prop prop) {
		return new StringBuilder().append("item[").append(rownum).append("].").append(prop.getName()).toString();
	}

	public static MessageSourceResolvable resolveItemProp(int rownum, AppliedEx10SubFormBase.Prop prop) {
		String formName = UPPER_CAMEL.to(LOWER_CAMEL, AppliedEx11Form.class.getSimpleName());
