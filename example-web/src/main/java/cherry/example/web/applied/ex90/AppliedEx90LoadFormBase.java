...
@EqualsAndHashCode
@ToString
public abstract class AppliedEx90LoadFormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "appliedEx90LoadForm.text10"), //
		Text100("text100", "appliedEx90LoadForm.text100"), //
		Int64("int64", "appliedEx90LoadForm.int64"), //
		Decimal1("decimal1", "appliedEx90LoadForm.decimal1"), //
		Decimal3("decimal3", "appliedEx90LoadForm.decimal3"), //
		DUMMY("dummy", "dummy");
