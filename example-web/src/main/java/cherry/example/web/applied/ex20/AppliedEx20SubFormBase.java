...
@EqualsAndHashCode
@ToString
public abstract class AppliedEx20SubFormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "appliedEx20SubForm.text10"), //
		Text100("text100", "appliedEx20SubForm.text100"), //
		Int64("int64", "appliedEx20SubForm.int64"), //
		Decimal1("decimal1", "appliedEx20SubForm.decimal1"), //
		Decimal3("decimal3", "appliedEx20SubForm.decimal3"), //
		Dt("dt", "appliedEx20SubForm.dt"), //
		Tm("tm", "appliedEx20SubForm.tm"), //
		Dtm("dtm", "appliedEx20SubForm.dtm"), //
		LockVersion("lockVersion", "appliedEx20SubForm.lockVersion"), //
		DUMMY("dummy", "dummy");
