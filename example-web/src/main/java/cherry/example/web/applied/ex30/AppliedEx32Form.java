...
@EqualsAndHashCode
@ToString
public class AppliedEx32Form {

	@NotNull()
	@Valid()
	private Map<Integer, AppliedEx31SubForm> item;

	public static String getItemPropName(int rownum, AppliedEx31SubFormBase.Prop prop) {
