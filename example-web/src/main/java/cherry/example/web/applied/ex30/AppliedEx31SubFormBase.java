...
@EqualsAndHashCode
@ToString
public abstract class AppliedEx31SubFormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "appliedEx31SubForm.text10"), //
		Text100("text100", "appliedEx31SubForm.text100"), //
		Int64("int64", "appliedEx31SubForm.int64"), //
		Decimal1("decimal1", "appliedEx31SubForm.decimal1"), //
		Decimal3("decimal3", "appliedEx31SubForm.decimal3"), //
		Dt("dt", "appliedEx31SubForm.dt"), //
		Tm("tm", "appliedEx31SubForm.tm"), //
		Dtm("dtm", "appliedEx31SubForm.dtm"), //
		LockVersion("lockVersion", "appliedEx31SubForm.lockVersion"), //
		DUMMY("dummy", "dummy");
