...
@EqualsAndHashCode
@ToString
public abstract class AppliedEx10SubFormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		Text10("text10", "appliedEx10SubForm.text10"), //
		Text100("text100", "appliedEx10SubForm.text100"), //
		Int64("int64", "appliedEx10SubForm.int64"), //
		Decimal1("decimal1", "appliedEx10SubForm.decimal1"), //
		Decimal3("decimal3", "appliedEx10SubForm.decimal3"), //
		Dt("dt", "appliedEx10SubForm.dt"), //
		Tm("tm", "appliedEx10SubForm.tm"), //
		Dtm("dtm", "appliedEx10SubForm.dtm"), //
		LockVersion("lockVersion", "appliedEx10SubForm.lockVersion"), //
		DUMMY("dummy", "dummy");
