...
@Controller
public class FormEx30ControllerImpl implements FormEx30Controller {

	private final String viewnameOfStart = ViewNameUtil.fromMethodCall(on(FormEx30Controller.class).start(null, null,
			null, null, null, null));
	...
	@Override
	public ModelAndView start(FormEx30Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
		return withViewname(viewnameOfStart).build();
	}

	@Override
	public ModelAndView confirm(FormEx30Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
	...
	@Override
	public ModelAndView back(FormEx30Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
		return withViewname(viewnameOfStart).build();
	}
