...
public class FormEx10ControllerImpl implements FormEx10Controller {
	...
	private final String viewnameOfStart = ViewNameUtil.fromMethodCall(on(FormEx10Controller.class).start(null, null,
			null, null, null, null));
	...
	@Override
	public ModelAndView start(FormEx10Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
		return withViewname(viewnameOfStart).build();
	}

	@Override
	public ModelAndView confirm(FormEx10Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
	...
	@Override
	public ModelAndView back(FormEx10Form form, BindingResult binding, Authentication auth, Locale locale,
			SitePreference sitePref, NativeWebRequest request) {
		return withViewname(viewnameOfStart).build();
	}
