...
import cherry.common.db.gen.query.QMailLog;
import cherry.common.db.gen.query.QMailQueue;
import cherry.common.db.gen.query.QMailRcpt;
...
public class MessageStoreImpl implements MessageStore {
	...
	public List<Long> listMessage(LocalDateTime dtm) {
		...
		query.where(mq.scheduledAt.loe(dtm), mq.deletedFlg.eq(DeletedFlag.NOT_DELETED.code()));
