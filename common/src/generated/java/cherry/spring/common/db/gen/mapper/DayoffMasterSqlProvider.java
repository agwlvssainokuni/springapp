...
import cherry.spring.common.db.gen.dto.DayoffMasterCriteria.Criteria;
import cherry.spring.common.db.gen.dto.DayoffMasterCriteria.Criterion;
import cherry.spring.common.db.gen.dto.DayoffMasterCriteria;
import java.util.List;
import java.util.Map;

public class DayoffMasterSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(DayoffMasterCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("DAYOFF_MASTER");
     ...
     * @mbggenerated
     */
    public String deleteByExample(DayoffMasterCriteria example) {
        BEGIN();
        DELETE_FROM("DAYOFF_MASTER");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(DayoffMaster record) {
        BEGIN();
        INSERT_INTO("DAYOFF_MASTER");
     ...
     * @mbggenerated
     */
    public String selectByExample(DayoffMasterCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        DayoffMaster record = (DayoffMaster) parameter.get("record");
        DayoffMasterCriteria example = (DayoffMasterCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(DayoffMaster record) {
        BEGIN();
        UPDATE("DAYOFF_MASTER");
     ...
     * @mbggenerated
     */
    protected void applyWhere(DayoffMasterCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
