...
import cherry.common.db.gen.dto.NumberingMasterCriteria.Criteria;
import cherry.common.db.gen.dto.NumberingMasterCriteria.Criterion;
import cherry.common.db.gen.dto.NumberingMasterCriteria;
import java.util.List;
import java.util.Map;

public class NumberingMasterSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(NumberingMasterCriteria example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated
     */
    public String deleteByExample(NumberingMasterCriteria example) {
        BEGIN();
        DELETE_FROM("NUMBERING_MASTER");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(NumberingMaster record) {
        BEGIN();
        INSERT_INTO("NUMBERING_MASTER");
        ...
        if (record.getMinValue() != null) {
            VALUES("MIN_VALUE", "#{minValue,jdbcType=BIGINT}");
        }
        
        if (record.getMaxValue() != null) {
            VALUES("MAX_VALUE", "#{maxValue,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(NumberingMasterCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        NumberingMaster record = (NumberingMaster) parameter.get("record");
        NumberingMasterCriteria example = (NumberingMasterCriteria) parameter.get("example");
        ...
        if (record.getMinValue() != null) {
            SET("MIN_VALUE = #{record.minValue,jdbcType=BIGINT}");
        }
        
        if (record.getMaxValue() != null) {
            SET("MAX_VALUE = #{record.maxValue,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(NumberingMaster record) {
        BEGIN();
        UPDATE("NUMBERING_MASTER");
        ...
        if (record.getMaxValue() != null) {
            SET("MAX_VALUE = #{maxValue,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(NumberingMasterCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
