...
import cherry.common.db.gen.dto.SignupRequestCriteria.Criterion;
import cherry.common.db.gen.dto.SignupRequestCriteria;
import java.util.List;
import java.util.Map;

public class SignupRequestSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(SignupRequestCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("SIGNUP_REQUEST");
     ...
     * @mbggenerated
     */
    public String deleteByExample(SignupRequestCriteria example) {
        BEGIN();
        DELETE_FROM("SIGNUP_REQUEST");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(SignupRequest record) {
        BEGIN();
        INSERT_INTO("SIGNUP_REQUEST");
        ...
        if (record.getAppliedAt() != null) {
            VALUES("APPLIED_AT", "#{appliedAt,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(SignupRequestCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SignupRequest record = (SignupRequest) parameter.get("record");
        SignupRequestCriteria example = (SignupRequestCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(SignupRequest record) {
        BEGIN();
        UPDATE("SIGNUP_REQUEST");
        ...
        if (record.getAppliedAt() != null) {
            SET("APPLIED_AT = #{appliedAt,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(SignupRequestCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
