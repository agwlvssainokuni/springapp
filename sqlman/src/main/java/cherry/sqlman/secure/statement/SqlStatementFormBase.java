...
@EqualsAndHashCode
@ToString
public abstract class SqlStatementFormBase implements Serializable {
	...
	@Getter
	public enum Prop {
		DatabaseName("databaseName", "sqlStatementForm.databaseName"), //
		Sql("sql", "sqlStatementForm.sql"), //
		ParamMap("paramMap", "sqlStatementForm.paramMap"), //
		LockVersion("lockVersion", "sqlStatementForm.lockVersion"), //
		DUMMY("dummy", "dummy");
