...
public interface SqlStatementIdController {
	...
	@ModelAttribute()
	SqlStatementForm getForm(@PathVariable(ParamDef.PATHVAR_ID) int id);
	...
	ModelAndView execute(@PathVariable(ParamDef.PATHVAR_ID) int id, @Validated(G3.class) SqlStatementForm form,
	...
	ModelAndView download(@PathVariable(ParamDef.PATHVAR_ID) int id, @Validated(G3.class) SqlStatementForm form,
			BindingResult binding, Authentication auth, Locale locale, SitePreference sitePref,
	...
	ModelAndView update(@PathVariable(ParamDef.PATHVAR_ID) int id, @Validated(G2.class) SqlStatementForm form,
			BindingResult binding, Authentication auth, Locale locale, SitePreference sitePref,
			HttpServletRequest request);
