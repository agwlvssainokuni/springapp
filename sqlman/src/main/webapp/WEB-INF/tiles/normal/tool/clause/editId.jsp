	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
				<a data-toggle="collapse" href="#metadataForm"><s:message code="tool/clause/page.message.1" /></a>
			</h3>
		</div>
		<c:set var="hasError">
				...
				<f:form servletRelativeAction="${baseUri}/metadata" method="POST" modelAttribute="sqlMetadataForm" cssClass="form-horizontal" role="form">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<a href="${baseUri}" class="btn btn-default"><s:message code="tool/clause/page.finishButton" /></a>
						</div>
					</div>
				</f:form>
			</div>
	...
	<div class="panel panel-default">
		...
		<div id="clauseForm" class="panel-collapse collapse in">
			<div class="panel-body">
				...
				<f:form servletRelativeAction="${baseUri}/update" method="POST" modelAttribute="sqlClauseForm" cssClass="form-horizontal" role="form">
					...
					<div class="form-group ${hasError}">
						...
						<div class="col-sm-10">
							<f:textarea path="from" cssClass="form-control" />
						</div>
					</div>
					<c:set var="hasError">
					...
					<div class="form-group ${hasError}">
						...
						<div class="col-sm-10">
							<f:textarea path="where" cssClass="form-control" />
						</div>
					</div>
					<c:set var="hasError">
