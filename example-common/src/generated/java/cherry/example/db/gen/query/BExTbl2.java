...
/**
 * BExTbl2 is a Querydsl bean type
 */
@Generated("com.mysema.query.codegen.BeanSerializer")
public class BExTbl2 {
    ...
    public String toString() {
         return "code2 = " + code2 + ", createdAt = " + createdAt + ", decimal1 = " + decimal1 + ", decimal3 = " + decimal3 + ", dt = " + dt + ", dtm = " + dtm + ", id = " + id + ", int64 = " + int64 + ", lockVersion = " + lockVersion + ", parentId = " + parentId + ", text10 = " + text10 + ", text100 = " + text100 + ", tm = " + tm + ", updatedAt = " + updatedAt;
    }
