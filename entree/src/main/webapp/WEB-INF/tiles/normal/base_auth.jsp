		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a hreF="<c:url value="/secure/" />"><span class="glyphicon glyphicon-home"></span> <s:message code="base/auth.menu.home" /></a></li>
					<li><a hreF="<c:url value="/secure/passwd" />"><span class="glyphicon glyphicon-user"></span> <s:message
