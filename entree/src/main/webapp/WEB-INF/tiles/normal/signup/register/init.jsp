...
<f:form servletRelativeAction="/signup/${token}/execute" method="POST" modelAttribute="signupRegisterForm" role="form"
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<f:input path="lastName" cssClass="form-control" cssErrorClass="form-control has-error" />
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<f:input path="firstName" cssClass="form-control" cssErrorClass="form-control has-error" />
		</div>
	</div>
	<div class="form-group">
