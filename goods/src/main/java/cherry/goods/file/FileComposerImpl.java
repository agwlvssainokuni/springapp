...
public class FileComposerImpl implements FileComposer {

	@Override
	public File composeFile(File basedir, List<String> path) {
	...
	@Override
	public List<String> decomposeFile(File basedir, File file) {
