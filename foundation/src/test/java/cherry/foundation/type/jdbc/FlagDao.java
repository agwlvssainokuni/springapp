...
@Component
public class FlagDao implements InitializingBean {
	...
	public List<VerifyFlag> selectAll() {
		return namedParameterJdbcOperations.query(selectAllSql, rowMapperCreator.create(VerifyFlag.class));
	}

	public int insert(VerifyFlag record, KeyHolder keyHolder) {
