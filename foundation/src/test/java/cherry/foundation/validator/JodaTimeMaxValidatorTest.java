...
public class JodaTimeMaxValidatorTest {
	...
	public void testOK() {
		...
		assertEquals(new LocalDate(3000, 1, 1), dto.getVal1());
		assertEquals(new LocalDate(2999, 12, 31), dto.getVal2());
		assertEquals(new LocalDateTime(3000, 1, 1, 0, 0, 0), dto.getVal3());
		assertEquals(new LocalDateTime(2999, 12, 31, 23, 59, 59), dto.getVal4());
