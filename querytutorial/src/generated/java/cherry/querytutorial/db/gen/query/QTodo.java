...
public class QTodo extends com.mysema.query.sql.RelationalPathBase<BTodo> {
    ...
    private static final long serialVersionUID = -1404123023;
    ...
    public final DatePath<org.joda.time.LocalDate> dueDt = createDate("dueDt", org.joda.time.LocalDate.class);
    ...
    public void addMetadata() {
        ...
        addMetadata(description, ColumnMetadata.named("DESCRIPTION").withIndex(8).ofType(Types.VARCHAR).withSize(1000).notNull());
        ...
        addMetadata(dueDt, ColumnMetadata.named("DUE_DT").withIndex(4).ofType(Types.DATE).withSize(8).notNull());
        ...
        addMetadata(priorityCd, ColumnMetadata.named("PRIORITY_CD").withIndex(7).ofType(Types.INTEGER).withSize(10).notNull());
