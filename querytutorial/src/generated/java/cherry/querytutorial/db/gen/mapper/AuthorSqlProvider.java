...
import cherry.querytutorial.db.gen.dto.AuthorCriteria.Criteria;
import cherry.querytutorial.db.gen.dto.AuthorCriteria.Criterion;
...
public class AuthorSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(AuthorCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("AUTHOR");
     ...
     * @mbggenerated
     */
    public String deleteByExample(AuthorCriteria example) {
        BEGIN();
        DELETE_FROM("AUTHOR");
        applyWhere(example, false);
        return SQL();
     ...
     * @mbggenerated
     */
    public String selectByExample(AuthorCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        AuthorCriteria example = (AuthorCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    protected void applyWhere(AuthorCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
