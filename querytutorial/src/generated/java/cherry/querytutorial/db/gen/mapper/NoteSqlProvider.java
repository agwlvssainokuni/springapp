...
import cherry.querytutorial.db.gen.dto.NoteCriteria.Criteria;
import cherry.querytutorial.db.gen.dto.NoteCriteria.Criterion;
...
public class NoteSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(NoteCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("NOTE");
     ...
     * @mbggenerated
     */
    public String deleteByExample(NoteCriteria example) {
        BEGIN();
        DELETE_FROM("NOTE");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(Note record) {
        ...
        if (record.getTodoId() != null) {
            VALUES("TODO_ID", "#{todoId,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(NoteCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        NoteCriteria example = (NoteCriteria) parameter.get("example");
        ...
        if (record.getTodoId() != null) {
            SET("TODO_ID = #{record.todoId,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(NoteCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
